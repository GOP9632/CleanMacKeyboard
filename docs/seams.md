...
**全輸入鎖攔得下事件，攔不住那個箭頭。**#12 在真機上驗過：全輸入鎖底下點擊、拖曳與多指手勢完全沒有反應，但螢幕上的游標照樣跟著手指移動。游標的位置是視窗伺服器直接從 HID 那一層畫的，不經過事件進到登入 session 的那個攔截點。要真的把箭頭定住得換別的機制，那不在這個接縫上。畫面上的說明因此不承諾游標會停。
